 ...
 */
package com.renatobonfim.aem.core.models;
...
import com.renatobonfim.aem.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "react-arch51/components/helloworld");
